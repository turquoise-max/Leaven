-- Update RPC function to fully copy task templates (including assigned_role_ids, checklist, etc)
  ...
  LOOP
    ...
    WHILE v_date <= p_end_date LOOP
      ...
      IF v_should_create THEN
         ...
         -- We check title and date. Checking role_ids in SQL array equality might be fragile.
         -- If same title exists on same date, we skip.
         IF NOT EXISTS (
            SELECT 1 
            FROM tasks t
