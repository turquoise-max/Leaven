-- Create RPC function to generate tasks from templates
...
BEGIN
  ...
  LOOP
    ...
    WHILE v_date <= p_end_date LOOP
      ...
      -- Check if recurrence_rule->'days' contains the current day of week
      -- Using JSONB containment operator @>
      IF v_template.recurrence_rule IS NOT NULL 
         AND v_template.recurrence_rule ? 'days' 
         AND (v_template.recurrence_rule->'days') @> to_jsonb(v_dow) THEN
